    ...
    All: [
        {
            ...
            logo: "/assets/skills/mern.webp", // Example icon, you can use a custom one
            color: "#3FA037",
            proficiency: "Expert",
        ...
        },
        {
            ...
            logo: "/assets/skills/ml.webp", // Keep your custom icon or replace with an AI/ML icon
