...
interface ASTetressNavigationProps {
    onShowHelp: () => void;
}

const ASTetressNavigation: React.FC<ASTetressNavigationProps> = ({
    onShowHelp,
}) => {
...
export default ASTetressNavigation;
